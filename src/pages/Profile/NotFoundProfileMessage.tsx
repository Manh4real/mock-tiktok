...
import NotFound from "_/pages/NotFound";

function NotFoundProfileMessage() {
  return (
    <NotFound
      title="Couldn't find this account"
      subtitle="Looking for videos? Try browsing our trending creators, hashtags, and
    sounds."
    >
      <svg
        width="90"
...
export default NotFoundProfileMessage;
